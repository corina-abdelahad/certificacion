...
public class ControladorCampo {
    ...
    public boolean validarCampo(Campo campo){
        ...
        JOptionPane.showMessageDialog(null,"La suma de las superficies del lote debe ser igual a la superficie del campo","Imposible Registrar",JOptionPane.ERROR_MESSAGE);
        return false;
    }
